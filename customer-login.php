...
<head>
    ...
    <title>BeTech - Customer Login</title>
...
<div class="container-fluid account-page customer">
  ...
  <div class="account-wrapper">
    ...
    <div class="account-action-title">
      <span><h5><strong>BETECH CUSTOMER <span style="color: #30c777;">LOG IN</span></strong></h5></span>
    </div>
    ...
    <div class="container-fluid account-instructions">
      <div class="row">
        ...
        <div class="col-md-12"><p>New here? <a href="customer-register.php" class="link"> Sign Up</a></p></div>
