<?php
  ...
  if((isset($_SESSION['customer']))) {
    ...
    echo "You're logged in as admin. <a href='" . $root_url . "logout.php'>Log out</a> first then try again.";
...
<head>
    ...
    <title>BeTech - Customer Sign Up</title>
...
<div class="container-fluid account-page customer">
  ...
  <div class="account-wrapper">
    ...
    <div class="account-action-title">
      <span><h5><strong>BETECH CUSTOMER <span style="color: #30c777;">SIGNUP</span></strong></h5></span>
    </div>

    <form class="login-register-form" method="POST" action="customer-account-script.php">
    ...
    <div class="container-fluid account-instructions">
      <div class="row">
        ...
        <div class="col-md-12"><p>Have an account? <a href="customer-login.php" class="link"> Log in</a></p></div>
